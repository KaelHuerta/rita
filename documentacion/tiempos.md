...
GROUP BY
   ...
   ,tailnum;
-- 1+ hora
create index al_tail_year_month_ix on alfie.alfie (year, month, tailnum);
...
- De 7 horas a 3 con índice sobre la fecha (aunque le llevó una hora el índice).

Series de tiempo (Creación, indexado y aspirado)

- 3.5 horas a 1 hora con índices ordenados
